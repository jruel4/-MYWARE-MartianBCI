...
# Generate spectrogram stream name (include info about spect)
G_SpectroStreamName='SpectroFlat_' + str(G_SpectrogramShape[0]) + 'x' + str(G_SpectrogramShape[1]) + 'x' + str(G_SpectrogramShape[2]) + '_' + str(np.prod(G_SpectrogramShape))
...
block_LSL0 = pipeline.add_block(
        ...
        stream_name=G_SpectroStreamName,
        stream_type='PROC')
