...
with tf.Session() as sess:
    ...
    for i in range(200):
        ...
        if i % 100 == 0:
            ...
            sess.run(train_step,feed_dict={x: batch[0], y_: batch[1], keep_prob: 0.5}, options=run_options, run_metadata=run_metadata)
            mWriter.add_run_metadata(run_metadata, 'S: %d' % i)
        else:
