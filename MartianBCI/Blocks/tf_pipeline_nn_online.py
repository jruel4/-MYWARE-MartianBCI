...
#FIR Bandpass
fir_UID = pipeline_tf.add_block(_BLOCK=tf_block_fir, _PARENT_UID="RAW",
                                _NCHAN=G_NCHAN, _COEFFS=b)

band_powers_UID = pipeline_tf.add_block(tf_block_band_powers, _PARENT_UID=fir_UID,
                            _NCHAN=G_NCHAN, _SIGLEN=G_NSAMPLES, _BIN_WIDTH=0.25)


#Add TF Pipeline outputs
pipeline_tf.make_block_output(_BLOCK_UID=band_powers_UID, _BLOCK_OUTPUT_KEY="band_powers")
